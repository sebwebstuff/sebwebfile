...
function domContentLoaded() {
    initPokiSdk(); // This will now just set a flag
...
function setPokiInited() {
    // PokiSDK.gameLoadingStart(); // REMOVED
    pokiInited = true;
}

function initPokiSdk() {
    // All Poki init logic removed. We just set the flag directly.
    setPokiInited();
}
...
function pokiEnsureStop() {
    // PokiSDK.gameplayStop(); // REMOVED
    pokiStopped = true;
}

function pokiEnsureStart() {
    // PokiSDK.gameplayStart(); // REMOVED
    pokiStopped = false;
}
...
function tryStartGame() {
    ...
    // PokiSDK.gameLoadingFinished(); // REMOVED
    console.log("Starting game");
    
    // Bypassed commercial break, start game directly
    startGame();
...
function adRewardedShow(category, details, placement) {
    ...
    pokiEnsureStop(); // This is empty now, but safe to call
    
    // Simulate a successful rewarded ad: grant reward and report success
