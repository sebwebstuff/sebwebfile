...
'use strict';{if(window["C3_IsSupported"]){const enableWorker=false;window["c3_runtimeInterface"]=new self.RuntimeInterface({useWorker:enableWorker,workerMainUrl:"workermain.js",engineScripts:["https://cdn.jsdelivr.net/gh/sebwebstuff/sebwebfile/swingo/scripts/c3runtime.js"],projectScripts:[["scripts/project/main.js"], ["scripts/project/scriptsInEvents.js"]],mainProjectScript:"scripts/project/main.js",scriptFolder:"scripts/",workerDependencyScripts:[],exportType:"html5"})}};
